...
export class PackageService{
    ...
    static async GetPackageById(id: number): Promise<PublicPackage | null>{
        try {
            const response = await fetch(`${ConfigService.apiUrl}/package/get/${id}`,{
                method: "GET",
                headers:{
                    "Content-Type": "application/json",
                    "Authorization": ConfigService.getToken()!
    ...
    static async TakePackage(id:string): Promise<PublicPackage | null>{
        try {
            const response = await fetch(`${ConfigService.apiUrl}/package/${id}/take`,{
                method: "POST",
                headers:{
                    "Content-Type": "application/json",
                    "Authorization": ConfigService.getToken()!
    ...
    static async ReceivePackage(id:string): Promise<PublicPackage | null>{
        try {
            const response = await fetch(`${ConfigService.apiUrl}/package/${id}/recieve`,{
                method: "POST",
                headers:{
                    "Content-Type": "application/json",
                    "Authorization": ConfigService.getToken()!
    ...
    static async DeliverPackage(id:string): Promise<PublicPackage | null>{
        try {
            const response = await fetch(`${ConfigService.apiUrl}/package/${id}/deliver`,{
                method: "POST",
                headers:{
                    "Content-Type": "application/json",
                    "Authorization": ConfigService.getToken()!
